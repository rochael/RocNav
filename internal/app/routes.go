...
func (a *App) registerRoutes() {
	...
	a.Router.GET("/api/bookmarks/sync", a.authRequired(), a.bookmarkHandler.GetSync)
	a.Router.POST("/api/bookmarks/sync", a.authRequired(), a.bookmarkHandler.PostSync)
	a.Router.GET("/api/bookmarks", a.authRequired(), a.bookmarkHandler.List)
	a.Router.POST("/api/bookmarks", a.authRequired(), a.bookmarkHandler.Create)
	a.Router.PUT("/api/bookmarks/:id", a.authRequired(), a.bookmarkHandler.Update)
	a.Router.DELETE("/api/bookmarks/:id", a.authRequired(), a.bookmarkHandler.Delete)
	a.Router.PUT("/api/bookmarks/reorder", a.authRequired(), a.bookmarkHandler.Reorder)
